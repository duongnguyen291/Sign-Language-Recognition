...
target_folder = r'D:\github\introToAi\data\asl_alphabet_train\train_200_img'

def copy_in_one_folder(source_folder, target_folder):
...
def copy_in_many_folder(source_folder, target_folder):
    # Tạo thư mục mới nếu chưa tồn tại
    if not os.path.exists(target_folder):
        os.makedirs(target_folder)
...
copy_in_many_folder(source_folder,target_folder)